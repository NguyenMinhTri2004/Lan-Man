    ...
    <div className="overflow-hidden mt-5" >
          ...
          <div className="" >
                  ...
                  <div className="flex  xs:flex-col xs:text-[9px] md:text-base md:flex-row items-center md:gap-5 xs:gap-0 justify-center mb-20 text-center" >
                      ...
                      <h1 className="leading-[40px]" > để xem toàn bộ mẫu hoa của Lan Man  </h1>
                  </div>

                  <Wrapper>
                        <div className="bg-[url('/images/footer_bg1.svg')] bg-no-repeat  h-fit flex items-center justify-between xs:px-5 md:px-20 bg-left-bottom bg-contain" >
                              <div className="w-[50%]" >
